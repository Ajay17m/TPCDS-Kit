...
select c.* 
  from store_returns c 
       left join (select d_date_sk 
                    from date_dim 
                   where d_date between date1 and date2
                 )a on (c.sr_returned_date_sk=a.d_date_sk)
where a.d_date_sk is null;
...
select c.* 
  from store_sales c 
       left join (select d_date_sk 
                    from date_dim 
                   where d_date between date1 and date2
                 )a on (c.ss_sold_date_sk=a.d_date_sk)
where a.d_date_sk is null;
...
select c.* 
  from catalog_returns c 
       left join (select d_date_sk 
                    from date_dim 
                   where d_date between date1 and date2
                 )a on (c.cr_returned_date_sk=a.d_date_sk)
where a.d_date_sk is null;
...
select c.* 
  from catalog_sales c 
       left join (select d_date_sk 
                    from date_dim 
                   where d_date between date1 and date2
                 )a on (c.cs_sold_date_sk=a.d_date_sk)
where a.d_date_sk is null;
...
select c.* 
  from web_returns c 
       left join (select d_date_sk 
                    from date_dim 
                   where d_date between date1 and date2
                 )a on (c.wr_returned_date_sk=a.d_date_sk)
where a.d_date_sk is null;
...
select c.* 
  from web_sales c 
       left join (select d_date_sk 
                    from date_dim 
                   where d_date between date1 and date2
                 )a on (c.ws_sold_date_sk=a.d_date_sk)
where a.d_date_sk is null;
...
select c.* 
  from Inventory c 
       left join (select d_date_sk
                    from date_dim 
                   where d_date between date1 and date2
                 )a on (c.inv_date_sk=a.d_date_sk)
where a.d_date_sk is null;
